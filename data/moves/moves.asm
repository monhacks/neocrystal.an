...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move DOUBLESLAP,   EFFECT_MULTI_HIT,          15, NORMAL,        85, 10,   0, PHYSICAL ;Multi hit moves to be condensed
	move COMET_PUNCH,  EFFECT_MULTI_HIT,          18, FIGHTING,      85, 15,   0, PHYSICAL ;Multi hit moves to be condensed
	...
	move GUILLOTINE,   EFFECT_OHKO,                0, NORMAL,        30,  5,   0, PHYSICAL ;Remove if removing OHKO
	move RAZOR_WIND,   EFFECT_RAZOR_WIND,         80, NORMAL,        90, 10,   0, SPECIAL  ;Rarely used, swap for newer move
	...
	move BIND,         EFFECT_TRAP_TARGET,        15, NORMAL,        85, 20,   0, PHYSICAL ;Near duplicate of Bind
	...
	move ROLLING_KICK, EFFECT_FLINCH_HIT,         60, FIGHTING,      85, 15,  30, PHYSICAL ;Near duplicate of Low Kick
	...
	move FURY_ATTACK,  EFFECT_MULTI_HIT,          15, NORMAL,        85, 20,   0, PHYSICAL ;Multi hit moves to be condensed
	...
	move SUBMISSION,   EFFECT_RECOIL_HIT,         80, FIGHTING,      80, 20,   0, PHYSICAL
	move LOW_KICK,     EFFECT_FLINCH_HIT,         50, FIGHTING,     100, 20,  30, PHYSICAL ;Near duplicate of Rolling Kick
	...
	move FISSURE,      EFFECT_OHKO,                1, GROUND,        30,  5,   0, PHYSICAL ;Remove if removing OHKO
	...
	move BARRIER,      EFFECT_DEFENSE_UP_2,        0, PSYCHIC_TYPE, 100, 20,   0, STATUS
	...
	move BIDE,         EFFECT_BIDE,                0, NORMAL,       100, 10,   0, PHYSICAL ;Rarely used, replace with newer move
	move METRONOME,    EFFECT_METRONOME,           0, NORMAL,       100, 10,   0, STATUS   ;Too chaotic, replace with newer move
	move MIRROR_MOVE,  EFFECT_MIRROR_MOVE,         0, FLYING,       100, 20,   0, STATUS ;Rarely used, replace with newer move
	move SELFDESTRUCT, EFFECT_SELFDESTRUCT,      200, NORMAL,       100,  5,   0, PHYSICAL
	move EGG_BOMB,     EFFECT_NORMAL_HIT,        100, NORMAL,        75, 10,   0, PHYSICAL ;Rarely used, replace with newer move
	...
	move BONE_CLUB,    EFFECT_FLINCH_HIT,         65, GROUND,        85, 20,  10, PHYSICAL ;Nonlegendary exclusive, replace with newer move
	move FIRE_BLAST,   EFFECT_BURN_HIT,          110, FIRE,          85,  5,  10, SPECIAL
	move WATERFALL,    EFFECT_FLINCH_HIT,         80, WATER,        100, 15,   0, PHYSICAL
	move CLAMP,        EFFECT_TRAP_TARGET,        35, WATER,         85, 15,   0, PHYSICAL
	move SWIFT,        EFFECT_ALWAYS_HIT,         60, NORMAL,       100, 20,   0, SPECIAL
	move SKULL_BASH,   EFFECT_SKULL_BASH,        130, NORMAL,       100, 10,   0, PHYSICAL
	move SPIKE_CANNON, EFFECT_MULTI_HIT,          20, NORMAL,       100, 15,   0, PHYSICAL ;Multi hit moves to be condensed
	...
	move SOFTBOILED,   EFFECT_HEAL,                0, NORMAL,       100, 10,   0, STATUS ;Nonlegendary exclusive, replace with newer move
	...
	move BARRAGE,      EFFECT_MULTI_HIT,          15, NORMAL,        85, 20,   0, PHYSICAL ;Multi hit moves to be condensed
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          80, BUG,          100, 10,   0, PHYSICAL
	move LOVELY_KISS,  EFFECT_SLEEP,               0, NORMAL,        75, 10,   0, STATUS
	move SKY_ATTACK,   EFFECT_SKY_ATTACK,        140, FLYING,        90,  5,   0, PHYSICAL ;Rarely used, replace with newer move
	...
	move PSYWAVE,      EFFECT_PSYWAVE,             1, PSYCHIC_TYPE, 100, 15,   0, SPECIAL ;Rarely used, replace with newer move
	move SPLASH,       EFFECT_SPLASH,              0, NORMAL,       100, 40,   0, STATUS  ;Rarely used, replace with newer move
	...
	move FURY_SWIPES,  EFFECT_MULTI_HIT,          18, NORMAL,        80, 15,   0, PHYSICAL ;Multi hit moves to be condensed
	move BONEMERANG,   EFFECT_DOUBLE_HIT,         50, GROUND,        90, 10,   0, PHYSICAL ;Nonlegendary exclusive, replace with newer move
	move REST,         EFFECT_HEAL,                0, PSYCHIC_TYPE, 100, 10,   0, STATUS
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         75, ROCK,          90, 10,  30, PHYSICAL
	move HYPER_FANG,   EFFECT_FLINCH_HIT,         80, NORMAL,        90, 15,  10, PHYSICAL ;Nonlegendary exclusive, replace with newer move
	move SHARPEN,      EFFECT_ATTACK_UP,           0, NORMAL,       100, 30,   0, STATUS
	move CONVERSION,   EFFECT_CONVERSION,          0, NORMAL,       100, 30,   0, STATUS ;Nonlegendary exclusive, replace with newer move or proliferate
	move TRI_ATTACK,   EFFECT_TRI_ATTACK,         80, NORMAL,       100, 10,  20, SPECIAL
	move SUPER_FANG,   EFFECT_SUPER_FANG,          1, NORMAL,        90, 10,   0, PHYSICAL ;Nonlegendary exclusive, replace with newer move
	...
	move NIGHTMARE,    EFFECT_NIGHTMARE,           0, GHOST,        100, 15,   0, STATUS ;Rarely used, replace with newer move
	...
	move CONVERSION2,  EFFECT_CONVERSION2,         0, NORMAL,       100, 30,   0, STATUS ;Nonlegendary exclusive, replace with newer move or proliferate
	...
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  65, WATER,         85, 10,  50, SPECIAL ;Nonlegendary exclusive, replace with newer move or proliferate
	...
	move MILK_DRINK,   EFFECT_HEAL,                0, NORMAL,       100, 10,   0, STATUS ;Nonlegendary exclusive, replace with newer move or proliferate
	...
	move PURSUIT,      EFFECT_PURSUIT,            40, DARK,         100, 20,   0, PHYSICAL ;Rarely used, replace with newer move
	...
	move EXTREMESPEED, EFFECT_PRIORITY_HIT_2,     80, NORMAL,       100,  5,   0, PHYSICAL
	...
	move WHIRLPOOL,    EFFECT_TRAP_TARGET,        35, WATER,         85, 15,   0, SPECIAL
	move BEAT_UP,      EFFECT_BEAT_UP,            10, DARK,         100, 10,   0, PHYSICAL ;Rarely used, replace with newer move
	move MOONBLAST,    EFFECT_SP_ATK_DOWN_HIT,    95, FAIRY,        100, 10,  30, SPECIAL
