...
FalknerGroup:
	...
	db 11, HOOTHOOT,   TACKLE, MUD_SLAP, PECK, FORESIGHT
	db 13, SPEAROW,    PECK, MUD_SLAP, FURY_ATTACK, LEER
	db -1 ; end
...
BugsyGroup:
	...
	db 15, PINSIR,     CLAMP, FURY_CUTTER, FURY_ATTACK, BIND
	db 15, SCYTHER,    QUICK_ATTACK, LEER, FURY_CUTTER, FURY_SWIPES
	db -1 ; end
