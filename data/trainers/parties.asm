...
BrockGroup:
	...
	db 63, SHUCKLE,    TOXIC, CURSE, SUNNY_DAY, ROLLOUT
...
LtSurgeGroup:
	...
	db 63, ELECTABUZZ, BODY_SLAM, PSYCHIC, CROSS_CHOP, THUNDER
...
RedGroup:
	...
	db 88, PIKACHU,    MAGNET,       CHARM, IRON_TAIL, THUNDERBOLT, THUNDER_WAVE
	db 82, ESPEON,     GOLD_BERRY,   MUD_SLAP, REFLECT, SWIFT, PSYCHIC_M
	db 82, SNORLAX,    LEFTOVERS,    AMNESIA, SNORE, REST, BODY_SLAM
	db 84, VENUSAUR,   MIRACLESEED,  SUNNY_DAY, GIGA_DRAIN, SYNTHESIS, SOLARBEAM
