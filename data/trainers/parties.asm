...
BugsyGroup:
	...
	db 19, PARAS,      SCRATCH, STUN_SPORE, FURY_CUTTER, POISONPOWDER
	db 17, PINSIR,     VICEGRIP, FURY_CUTTER, FURY_ATTACK, BIND
	db 17, SCYTHER,    QUICK_ATTACK, LEER, FURY_CUTTER, FURY_SWIPES
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_MOVES
	db 25, GASTLY,     SHADOW_BALL, NIGHT_SHADE, MEAN_LOOK, MEGA_DRAIN
...
KarenGroup:
	...
	db 55, SNEASEL,    SWORDS_DANCE, SLASH, ICE_PUNCH, FAINT_ATTACK
