...
BugsyGroup:
	...
	db 15, SHUCKLE,    FURY_CUTTER, BIND, CONSTRICT, ROCK_THROW
...
YoungsterGroup:
	; YOUNGSTER JOEY (1) ROUTE_30
	db "JOEY@", TRAINERTYPE_NORMAL
	db  6, RATTATA
	db -1 ; end

	; YOUNGSTER MIKEY (2) ROUTE_30
	...
	; YOUNGSTER JOEY (7) ROUTE_30
	db "JOEY@", TRAINERTYPE_NORMAL
	db 15, RATTATA
	db -1 ; end

	; YOUNGSTER JOEY (8) ROUTE_30
