...
FalknerGroup:
	...
	db  7, PIDGEY,     TACKLE, MUD_SLAP, GUST, SAND_ATTACK
	db  7, HOOTHOOT,   TACKLE, MUD_SLAP, PECK, GROWL
	db 11, SPEAROW,    PECK, MUD_SLAP, FURY_ATTACK, LEER
	db -1 ; end
...
BugsyGroup:
	...
	db 17, PARAS,      SCRATCH, STUN_SPORE, FURY_CUTTER, POISONPOWDER
	db 17, PINSIR,     VICEGRIP, FURY_CUTTER, FOCUS_ENERGY, BIND
...
MortyGroup:
	...
	db 25, GASTLY,     SHADOW_BALL, NIGHT_SHADE, MEAN_LOOK, HYPNOSIS
	db 25, HAUNTER,    SHADOW_BALL, NIGHT_SHADE, MEAN_LOOK, HYPNOSIS
	db 28, MISDREAVUS, SCREECH, CONFUSE_RAY, SHADOW_BALL, PSYBEAM
...
Rival1Group:
	...
	db 29, BAYLEEF,    GROWL, REFLECT, RAZOR_LEAF, POISONPOWDER
	db -1 ; end
	...
	db 23, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 26, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 29, QUILAVA,    LEER, SMOKESCREEN, EMBER, QUICK_ATTACK
	db -1 ; end
	...
	db 42, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	...
	db 39, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 42, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 42, QUILAVA,    SMOKESCREEN, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 46, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 50, MEGANIUM,   REFLECT, RAZOR_LEAF, POISONPOWDER, BODY_SLAM
	db -1 ; end
	...
	db 46, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 50, TYPHLOSION, SMOKESCREEN, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
...
WillGroup:
	...
	db 53, XATU,       DRILL_PECK, FAINT_ATTACK, CONFUSE_RAY, PSYCHIC_M
	db 54, WOBBUFFET,  COUNTER, MIRROR_COAT, SAFEGUARD, DESTINY_BOND
	db 54, SLOWKING,   REFLECT, SWAGGER, SURF, PSYCHIC_M
	db 54, GIRAFARIG,  HEADBUTT, THUNDERBOLT, CRUNCH, PSYCHIC_M
	db 55, ESPEON,     MORNING_SUN, SWIFT, CHARM, PSYCHIC_M
	db -1 ; end
...
BrunoGroup:
	...
	db 55, HITMONTOP,  TRIPLE_KICK, QUICK_ATTACK, DIG, DETECT
	db 55, HITMONLEE,  SWAGGER, BODY_SLAM, HI_JUMP_KICK, FORESIGHT
	db 55, HITMONCHAN, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	db 57, HERACROSS,  MEGAHORN, REVERSAL, FLAIL, EARTHQUAKE
...
KarenGroup:
	...
	db 55, SNEASEL,    BEAT_UP, SLASH, ICE_BEAM, FAINT_ATTACK
	db 55, UMBREON,    SAND_ATTACK, CONFUSE_RAY, FAINT_ATTACK, MOONLIGHT
	db 59, HOUNDOOM,   CRUNCH, FLAMETHROWER, FAINT_ATTACK, REVERSAL
	db 58, MURKROW,    DRILL_PECK, FAINT_ATTACK, MUD_SLAP, STEEL_WING
	db 61, TYRANITAR,  EARTHQUAKE, CRUNCH, ROCK_SLIDE, STOMP
	db -1 ; end

KogaGroup:
	; KOGA (1)
	db "KOGA@", TRAINERTYPE_MOVES
	db 53, ARIADOS,    DOUBLE_TEAM, SPIDER_WEB, TOXIC, SLUDGE_BOMB
	db 54, WEEZING,    SMOKESCREEN, SLUDGE_BOMB, PAIN_SPLIT, TOXIC
	db 57, NIDOKING,   SLUDGE_BOMB, EARTHQUAKE, THIEF, ICE_BEAM
	db 55, MUK,        SLUDGE_BOMB, ACID_ARMOR, GIGA_DRAIN, SUBSTITUTE
	db 58, CROBAT,     CONFUSE_RAY, FAINT_ATTACK, WING_ATTACK, TOXIC
	db -1 ; end

ChampionGroup:
	; CHAMPION (1)
	db "LANCE@", TRAINERTYPE_ITEM_MOVES
	db 58, ARBOK,      GOLD_BERRY,   CRUNCH, ROCK_SLIDE, EARTHQUAKE, SLUDGE_BOMB
	db 61, GYARADOS,   BITTER_BERRY, RAIN_DANCE, SURF, THRASH, HYPER_BEAM
	db 60, AERODACTYL, GOLD_BERRY,   ANCIENTPOWER, DRAGONBREATH, EARTHQUAKE, HYPER_BEAM
	db 60, CHARIZARD,  BITTER_BERRY, FLAMETHROWER, OUTRAGE, EARTHQUAKE, SLASH
	db 61, KINGDRA,    GOLD_BERRY,   RAIN_DANCE, DRAGONBREATH, OCTAZOOKA, HYPER_BEAM
