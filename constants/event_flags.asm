...
; Johto story events
	...
	const EVENT_GOT_LONELY_STARTER
...
; Kanto story events
	...
	const EVENT_BINOCULARS_ARTICUNO
	const EVENT_BINOCULARS_ZAPDOS
	const EVENT_BINOCULARS_MOLTRES
